...
JSON Sample
-------------------------------------
{    "slug": "rmMDCBcXJZqljnbHAMmltiatn",    "name": "CMAWGFjwNVXHOtBWmFdusoGIw",    "created_at": "2205-01-28T05:25:48.579581126-03:00",    "updated_at": "2052-12-20T09:35:01.385390205-03:00",    "id": 0}
...
// PaymentStatus struct is a row record of the payment_status table in the laravel database
...
var payment_statusTableInfo = &TableInfo{
	Name: "payment_status",
	Columns: []*ColumnInfo{
...
func (p *PaymentStatus) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (p *PaymentStatus) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (p *PaymentStatus) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (p *PaymentStatus) TableInfo() *TableInfo {
	return payment_statusTableInfo
}
