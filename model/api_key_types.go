...
CREATE TABLE `api_key_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `api_key_types_slug_unique` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci

JSON Sample
-------------------------------------
{    "updated_at": "2201-06-13T21:27:33.618121992-03:00",    "id": 31,    "name": "VUPRCgbqxvUuKEajKyRHnJgpW",    "slug": "blCcfpnNIhfFWopQDAEiAaRwm",    "created_at": "2258-11-26T10:00:30.763856083-03:00"}
...
// APIKeyTypes struct is a row record of the api_key_types table in the laravel database
...
var api_key_typesTableInfo = &TableInfo{
	Name: "api_key_types",
	Columns: []*ColumnInfo{
...
func (a *APIKeyTypes) TableName() string {
	return "api_key_types"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (a *APIKeyTypes) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *APIKeyTypes) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *APIKeyTypes) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *APIKeyTypes) TableInfo() *TableInfo {
	return api_key_typesTableInfo
}
