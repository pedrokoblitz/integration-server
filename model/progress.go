...
JSON Sample
-------------------------------------
{    "id": 1,    "created_at": "2174-10-06T19:44:54.619673729-03:00",    "updated_at": "2275-08-29T07:17:31.302275657-03:00"}
...
// Progress struct is a row record of the progress table in the laravel database
...
var progressTableInfo = &TableInfo{
	Name: "progress",
	Columns: []*ColumnInfo{
...
func (p *Progress) BeforeSave() error {
	return nil
}
...
func (p *Progress) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (p *Progress) TableInfo() *TableInfo {
	return progressTableInfo
}
