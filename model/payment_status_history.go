...
JSON Sample
-------------------------------------
{    "id": 31,    "order_id": 84,    "old_status_id": 89,    "new_status_id": 66,    "created_at": "2218-10-03T15:22:01.346810814-03:00",    "updated_at": "2132-08-29T20:35:30.508881116-03:00"}
...
// PaymentStatusHistory struct is a row record of the payment_status_history table in the laravel database
...
var payment_status_historyTableInfo = &TableInfo{
...
func (p *PaymentStatusHistory) TableName() string {
	return "payment_status_history"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (p *PaymentStatusHistory) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (p *PaymentStatusHistory) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (p *PaymentStatusHistory) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (p *PaymentStatusHistory) TableInfo() *TableInfo {
	return payment_status_historyTableInfo
}
