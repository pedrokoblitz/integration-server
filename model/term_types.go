...
CREATE TABLE `term_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `term_types_slug_unique` (`slug`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci

JSON Sample
-------------------------------------
{    "updated_at": "2103-06-23T04:30:38.695441536-03:00",    "id": 78,    "slug": "VIWZakasHgLZmkRRKecvYcUFx",    "name": "gmJGVgJKYqXGdkxNRPbYUVoCA",    "created_at": "2283-08-25T06:31:08.516181283-03:00"}
...
// TermTypes struct is a row record of the term_types table in the laravel database
...
var term_typesTableInfo = &TableInfo{
	Name: "term_types",
	Columns: []*ColumnInfo{
...
func (t *TermTypes) TableName() string {
	return "term_types"
}

// BeforeSave invoked before saving, return an error if field is not populated.
func (t *TermTypes) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (t *TermTypes) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (t *TermTypes) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (t *TermTypes) TableInfo() *TableInfo {
	return term_typesTableInfo
}
