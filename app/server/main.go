...
import (
	...
	"github.com/pedrokoblitz/comm/api"
	"github.com/pedrokoblitz/comm/dao"
	// _ "github.com/pedrokoblitz/comm/docs"
...
// @title Sample CRUD api for laravel db
// @version 1.0
// @description Sample CRUD api for laravel db
// @termsOfService
...
`, BuildDate, BuildNumber, LatestCommit, RuntimeVer, BuiltOnOs)
	...
	db, err := gorm.Open("mysql", "default:default@/laravel?parseTime=true")
	if err != nil {
